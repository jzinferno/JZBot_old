...
from .memory import sysinfo_ram, sysinfo_swap
...
@dp.callback_query_handler(lambda c: c.data in ['hostname', 'kernel', 'os', 'arch', 'uptime', 'ram', 'swap', 'cpu', 'uname', 'neofetch', 'back'])
