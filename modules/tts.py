from main import dp, GetChatStatus, GetBotLang, outpdir
...
async def main_tts(msg):
    if await GetChatStatus(msg) is not False:
        try:
            ...
            if text == '':
                await JZBot.ReplyMsg(msg, tts_text('text_1'))
            else:
                file_name = outpdir + '/tts-' + JZBot.RundomName(10)
                ...
                await JZBot.ReplyVoice(msg, open(f'{file_name}.ogg', 'rb'))
        except:
            await JZBot.ReplyMsg(msg, tts_text('text_2'))
